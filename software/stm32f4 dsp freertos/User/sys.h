 ...
 */
#define task1 (uint8_t)KEY_1_DOWN
#define task2 (uint8_t)KEY_2_DOWN
#define task3 (uint8_t)KEY_3_DOWN
#define task4 (uint8_t)KEY_1_LONG
#define task5 (uint8_t)KEY_2_LONG
#define task6 (uint8_t)KEY_3_LONG
